...
public class Tool {
	...
	public String metaLangPlaceholderTokenName = null;
    ...
    public static Option[] optionDefs = {
		...
		new Option("metaLangPlaceholderTokenName",    "-metalang-placeholder", OptionArgType.STRING, "meta language placeholder token name"),
	};
